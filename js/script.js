...
// Creamos un arreglo de objetos con la información de los productos
const productos = [
    {
        id: 1,
        nombre:"leche",
...
// Creamos una variable carrito que se inicializa como un arreglo vacío o se carga desde el localStorage
let carrito = JSON.parse(localStorage.getItem("carrito")) || [];

// Recorremos el arreglo de productos y creamos un elemento HTML para cada uno de ellos
